  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown ">
      <a class="nav-link" data-toggle="dropdown" href="#">
        <img src="<?php echo  $_SESSION['hosting'] . $_SESSION['imagen']; ?>" class="user-image img-circle" alt="User Image" width="30" onerror="this.src='../dist/svg/user_default.svg';"> 
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-image">
            <img class="img-circle elevation-2" src="<?php echo  $_SESSION['hosting'] . $_SESSION['imagen']; ?>" alt="User Avatar" onerror="this.src='../dist/svg/user_default.svg';" />
          </div>
