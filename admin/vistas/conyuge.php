                          ...
                          <form id="form-conyuge" name="form-conyuge" method="POST">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-12">
                                <div class="form-group">
                                  <label for="num_documento">Nombres</label>
                                  <div class="input-group">
                                    <input type="number" name="num_documento" class="form-control" id="num_documento" placeholder="Nombres" />
                                  </div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-6 col-lg-12">
                                <div class="form-group">
                                  <label for="num_documento">Apellidos</label>
                                  <div class="input-group">
                                    <input type="number" name="num_documento" class="form-control" id="num_documento" placeholder="Apellidos" />
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="telefono1" id="telefono1" class="form-control" data-inputmask="'mask': ['999-999-999', '+51 999 999 999']" data-mask />
                                </div>
                            </div>    
                            <div class="col-12 col-sm-12 col-md-6 col-lg-12">
                                <div class="form-group">
                                  <label for="telefono">Teléfono 2</label>
                                  <input type="text" name="telefono2" id="telefono2" class="form-control" data-inputmask="'mask': ['999-999-999', '+51 999 999 999']" data-mask />
                                </div>
                            </div>    
                            <div class="col-12 col-sm-12 col-md-6 col-lg-12">
                                <div class="form-group">
                                  <label for="telefono">Teléfono 3</label>
                                  <input type="text" name="telefono3" id="telefono3" class="form-control" data-inputmask="'mask': ['999-999-999', '+51 999 999 999']" data-mask />
                                </div>
                            </div>    
                          </form>                   
